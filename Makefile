...
train-and-run:
	make train-nlu
	make train-core
	python -m rasa_core.run -c facebook -d models/current/dialogue -u models/current/nlu --port 5002 --credentials credentials.yml --debug --endpoints endpoints.yml & python -m rasa_core_sdk.endpoint --actions actions
